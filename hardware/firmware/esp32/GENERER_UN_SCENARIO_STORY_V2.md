...
- template: `story_specs/templates/scenario.template.yaml`
- exemple existant: `story_specs/scenarios/default_unlock_win_etape2.yaml`
- schéma de référence: `story_specs/schema/story_spec_v1.yaml`

Crée un nouveau fichier dans `story_specs/scenarios/`, par exemple:
...
- Garde un scénario « de secours » valide dans `story_specs/scenarios/`.
