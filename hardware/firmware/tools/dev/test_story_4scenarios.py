#!/usr/bin/env python3
"""Run a 4-scenario Story V2 serial loop using StoryFsManager commands."""
...
def run_scenario(ser: serial.Serial, name: str, scenario_id: str, force_step: str, log) -> bool:
    ...
    send_cmd(ser, f"STORY_LOAD_SCENARIO {scenario_id}")
    if not wait_for_token(ser, "STORY_LOAD_SCENARIO_OK", 2.0):
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Story V2 4-scenario serial loop")
