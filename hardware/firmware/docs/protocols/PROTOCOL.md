...
- `STORY_*`: `STORY_STATUS`, `STORY_HELP`, `STORY_RESET`, `STORY_ARM`, `STORY_FORCE_ETAPE2`, `STORY_TEST_ON`, `STORY_TEST_OFF`, `STORY_TEST_DELAY`, `STORY_LOAD_SCENARIO`, `STORY_FORCE_STEP`, `STORY_FS_LIST`, `STORY_FS_VALIDATE`, `STORY_DEPLOY`, `STORY_V2_ENABLE`, `STORY_V2_STATUS`, `STORY_V2_LIST`, `STORY_V2_VALIDATE`, `STORY_V2_HEALTH`, `STORY_V2_TRACE`, `STORY_V2_TRACE_LEVEL`, `STORY_V2_METRICS`, `STORY_V2_METRICS_RESET`, `STORY_V2_EVENT`, `STORY_V2_STEP`, `STORY_V2_SCENARIO`
