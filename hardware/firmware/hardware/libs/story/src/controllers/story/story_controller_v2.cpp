...
bool StoryControllerV2::activateScenario(const ScenarioDef& scenario, uint32_t nowMs, const char* source) {
  if (!initialized_) {
...
bool StoryControllerV2::setScenario(const char* scenarioId, uint32_t nowMs, const char* source) {
  ...
  return activateScenario(*scenario, nowMs, source);
}

bool StoryControllerV2::setScenarioFromDefinition(const ScenarioDef& scenario,
                                                  uint32_t nowMs,
                                                  const char* source) {
  return activateScenario(scenario, nowMs, source);
}
